...
export default function CollectionCard({ collection, href }: CollectionCardProps) {
  return (
      ...
      <div className="rounded-2xl border-2 border-solid border-white/30 bg-purple-100/5 flex flex-col shadow-none w-full min-w-[350px] transition-all duration-200 hover:scale-[1.02] active:scale-[1.01] hover:bg-black/30 active:bg-white/30 cursor-pointer h-full">
        ...
        <div className="flex flex-col flex-1 pt-5">
          ...
          <div className="px-6 flex-1 flex flex-col">
            {/* Title: Left aligned */}
            <h3 className="text-left text-xl md:text-2xl font-semibold tracking-[-0.01em] bg-gradient-to-br from-purple-100 to-orange-300 bg-clip-text text-transparent mb-2">
              {collection.name}
            </h3>
