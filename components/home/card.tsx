  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-lg text-center">
        <h2 className="bg-gradient-to-br from-black to-stone-500 bg-clip-text font-display text-2xl font-bold text-transparent [text-wrap:balance] md:text-3xl md:font-normal">
          {title}
        </h2>
            ...
            components={{
              ...
              code: ({ node, ...props }) => (
                <code
                  ...
                  inline="true"
                  className="rounded-sm bg-gray-100 px-1 py-0.5 font-mono font-light text-gray-800"
                />
              ),
            }}
          >
