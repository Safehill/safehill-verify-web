  ...
  return (
    <div className="w-full flex flex-col sm:flex-row justify-center items-center gap-4 my-10 py-5 px-5">
      ...
      <a
        ...
        className="px-6 py-2 bg-yellow-100/80 font-display text-black text-base rounded-lg transform transition-all duration-100 hover:scale-105 hover:shadow-lg hover:bg-yellow/80 hover:text-teal-800"
      >
        Book a demo
      </a>
    </div>
