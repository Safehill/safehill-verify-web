...
const mockCollections = [
  ...
  },
  {
    ...
    description: 'A confidential collection shared with the development user by Alice Johnson.',
    assetCount: 12,
    visibility: 'confidential' as Visibility,
    pricing: 30,
...
const mockCollectionDetails = {
  '1': {
    ...
    createdBy: 'user1',
    assets: [
      { id: '1', name: 'Mountain Lake', type: 'image', size: '2.4 MB', uploaded: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '2', name: 'Forest Path', type: 'image', size: '1.8 MB', uploaded: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '3', name: 'Sunset Valley', type: 'image', size: '3.1 MB', uploaded: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '2': {
    id: '2',
    ...
    createdBy: 'user1',
    assets: [
      { id: '4', name: 'Modern Skyscraper', type: 'image', size: '1.9 MB', uploaded: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '5', name: 'Historic Building', type: 'image', size: '2.2 MB', uploaded: new Date(Date.now() - 7 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '3': {
    id: '3',
    ...
    createdBy: 'user1',
    assets: [
      { id: '6', name: 'Professional Headshot', type: 'image', size: '1.5 MB', uploaded: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '7', name: 'Environmental Portrait', type: 'image', size: '2.8 MB', uploaded: new Date(Date.now() - 3 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '4': {
    id: '4',
    ...
    createdBy: 'user2',
    assets: [
      { id: '8', name: 'Abstract Pattern', type: 'image', size: '3.2 MB', uploaded: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '9', name: 'Texture Study', type: 'image', size: '2.1 MB', uploaded: new Date(Date.now() - 5 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '5': {
    id: '5',
    ...
    createdBy: 'user2',
    assets: [
      { id: '10', name: 'Travel Video', type: 'video', size: '15.2 MB', uploaded: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
      { id: '11', name: 'Cultural Event', type: 'image', size: '2.7 MB', uploaded: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '6': {
    id: '6',
  ...
  '7': {
    ...
    createdBy: 'dev-user-123',
    assets: [
      { id: '14', name: 'Test Image 1', type: 'image', size: '1.2 MB', uploaded: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString() },
      { id: '15', name: 'Test Image 2', type: 'image', size: '0.8 MB', uploaded: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString() },
      { id: '16', name: 'Test Document', type: 'document', size: '0.5 MB', uploaded: new Date(Date.now() - 1 * 60 * 60 * 1000).toISOString() },
    ]
  },
  '8': {
    id: '8',
    ...
    createdBy: 'dev-user-123',
    assets: [
      { id: '17', name: 'Private Image 1', type: 'image', size: '2.1 MB', uploaded: new Date(Date.now() - 30 * 60 * 1000).toISOString() },
      { id: '18', name: 'Private Image 2', type: 'image', size: '1.7 MB', uploaded: new Date(Date.now() - 30 * 60 * 1000).toISOString() },
    ]
  },
  '9': {
    id: '9',
    ...
    createdBy: 'user1',
    assets: [
      { id: '19', name: 'Shared Image 1', type: 'image', size: '2.3 MB', uploaded: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString() },
      { id: '20', name: 'Shared Image 2', type: 'image', size: '1.9 MB', uploaded: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString() },
      { id: '21', name: 'Shared Document', type: 'document', size: '0.8 MB', uploaded: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString() },
    ]
  },
};
...
const mockUsers = {
  'user1': { identifier: 'user1', name: 'Alice Johnson', email: 'alice@example.com' },
  'user2': { identifier: 'user2', name: 'Bob Smith', email: 'bob@example.com' },
  'user3': { identifier: 'user3', name: 'Carol Davis', email: 'carol@example.com' },
...
export const collectionsApi = {
  ...
  getCollections: async (authenticatedUser: AuthenticatedUser): Promise<Collection[]> => {
    // Simulate API delay
    ...
    const ownedCollections = mockCollections.filter(collection => collection.createdBy === userId);

    // Get collections shared with the user
    const sharedCollectionIds = mockSharedCollections[userId as keyof typeof mockSharedCollections] || [];
  ...
  getCollection: async (id: string, authenticatedUser: AuthenticatedUser): Promise<CollectionDetail> => {
    // Simulate API delay
    ...
    const isShared = (mockSharedCollections[userId as keyof typeof mockSharedCollections] || []).includes(id);

    if (!isOwner && !isShared) {
      throw new Error('Access denied - you do not have access to this collection');
    }
  ...
  searchCollections: async (query: string, authenticatedUser: AuthenticatedUser): Promise<Collection[]> => {
